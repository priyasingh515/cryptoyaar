...
<head>
	...
	<link rel="alternate" type="application/rss+xml" title=""
		href="https://demo.kamleshyadav.com/themeforest/videospire/videospire-rtl/feed/">
	<link rel="alternate" type="application/rss+xml" title=""
		href="https://demo.kamleshyadav.com/themeforest/videospire/videospire-rtl/comments/feed/">
	<script>
		window._wpemojiSettings = { "baseUrl": "https:\/\/s.w.org\/images\/core\/emoji\/16.0.1\/72x72\/", "ext": ".png", "svgUrl": "https:\/\/s.w.org\/images\/core\/emoji\/16.0.1\/svg\/", "svgExt": ".svg", "source": { "concatemoji": "https:\/\/demo.kamleshyadav.com\/themeforest\/videospire\/videospire-rtl\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.8.3" } };
	...
	<link rel="stylesheet" id="wp-block-library-rtl-css" href="assets/css/style-rtl.min.css" media="all">
	...
	<link rel="stylesheet" id="woocommerce-add-to-cart-form-style-rtl-css" href="assets/css/add-to-cart-form-style.css"
		media="all">
	...
	<link rel="stylesheet" id="woocommerce-product-filter-price-slider-style-rtl-css"
		href="{{asset('assets/css/product-filter-price-slider-style.css')}}" media="all">
	...
	<link rel="stylesheet" id="woocommerce-product-gallery-style-rtl-css" href="assets/css/product-gallery-style.css"
		media="all">
	...
	<link rel="stylesheet" id="jquery-selectBox-css" href="{{asset('assets/css/jquery.selectBox.css')}}" media="all">
	<link rel="stylesheet" id="yith-wcwl-font-awesome-css" href="{{asset('assets/css/font-awesome.css')}}" media="all">
	<link rel="stylesheet" id="woocommerce_prettyPhoto_css-rtl-css" href="{{asset('assets/css/prettyPhoto-rtl.css')}}" media="all">
	<link rel="stylesheet" id="yith-wcwl-main-css" href="{{asset('assets/css/style.css')}}" media="all">
	...
	<link rel="stylesheet" id="contact-form-7-css" href="{{asset('assets/css/styles.css')}}" media="all">
	<link rel="stylesheet" id="contact-form-7-rtl-css" href="{{asset('assets/css/styles-rtl.css')}}" media="all">
	<link rel="stylesheet" id="toastr-style-css" href="{{asset('assets/css/toastr.min.css')}}" media="all">
	<link rel="stylesheet" id="woocommerce-layout-rtl-css" href="{{asset('assets/css/woocommerce-layout-rtl.css')}}" media="all">
	<link rel="stylesheet" id="woocommerce-smallscreen-rtl-css" href="{{asset('assets/css/woocommerce-smallscreen-rtl.css')}}"
		media="only screen and (max-width: 768px)">
	<link rel="stylesheet" id="woocommerce-general-rtl-css" href="{{asset('assets/css/woocommerce-rtl.css')}}" media="all">
	<link rel="stylesheet" id="yith-quick-view-css" href="{{asset('assets/css/yith-quick-view.css')}}" media="all">
	...
	<link rel="stylesheet" id="brands-styles-css" href="{{asset('assets/css/brands.css')}}" media="all">
	...
	<link rel="stylesheet" id="videospire-style-css" href="{{asset('assets/css/style.css')}}" media="all">
	<link rel="stylesheet" id="bootstrap-css" href="{{asset('assets/css/bootstrap.min.css')}}" media="all">
	<link rel="stylesheet" id="magnific-popup-css" href="{{asset('assets/css/magnific-popup.css')}}" media="all">
	<link rel="stylesheet" id="nice-select-css" href="{{asset('assets/css/nice-select.css')}}" media="all">
	<link rel="stylesheet" id="font-css" href="{{asset('assets/css/fonts.css')}}" media="all">
	<link rel="stylesheet" id="swiper-bundle-css" href="{{asset('assets/css/swiper-bundle.min.css')}}" media="all">
	<link rel="stylesheet" id="fontawesome-css" href="{{asset('assets/css/fontawesome.min.css')}}" media="all">
	<link rel="stylesheet" id="jjplayer-blue-monday-min-css" href="{{asset('assets/css/jplayer.blue.monday.min.css')}}" media="all">
	<link rel="stylesheet" id="videospire-custom-style-css" href="{{asset('assets/css/videospire-custom-style.css')}}" media="all">
	<link rel="stylesheet" id="videospire-theme-change-css" href="{{asset('assets/css/videospire-rtl')}}" media="all">
	<link rel="stylesheet" id="js_composer_front-css" href="{{asset('assets/css/js_composer.min.css')}}" media="all">
	...
	<script src="{{asset('assets/js/jquery.blockUI.min.js')}}" id="jquery-blockui-js" data-wp-strategy="defer"></script>
	<script id="wc-add-to-cart-js-extra">
		var wc_add_to_cart_params = { "ajax_url": "\/themeforest\/videospire\/videospire-rtl\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/themeforest\/videospire\/videospire-rtl\/?wc-ajax=%%endpoint%%", "i18n_view_cart": "\u0639\u0631\u0636 \u0627\u0644\u0633\u0644\u0629", "cart_url": "https:\/\/demo.kamleshyadav.com\/themeforest\/videospire\/videospire-rtl\/cart\/", "is_cart": "", "cart_redirect_after_add": "no" };
	</script>
	<script src="{{asset('assets/js/add-to-cart.min.js')}}" id="wc-add-to-cart-js" data-wp-strategy="defer"></script>
	<script src="{{asset('assets/js/js.cookie.min.js')}}" id="js-cookie-js" defer="" data-wp-strategy="defer"></script>
	<script id="woocommerce-js-extra">
		var woocommerce_params = { "ajax_url": "\/themeforest\/videospire\/videospire-rtl\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/themeforest\/videospire\/videospire-rtl\/?wc-ajax=%%endpoint%%", "i18n_password_show": "\u0639\u0631\u0636 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631", "i18n_password_hide": "\u0625\u062e\u0641\u0627\u0621 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631" };
	</script>
	<script src="{{asset('assets/js/woocommerce.min.js')}}" id="woocommerce-js" defer="" data-wp-strategy="defer"></script>
	<script src="{{asset('assets/js/woocommerce-add-to-cart.js')}}" id="vc_woocommerce-add-to-cart-js-js"></script>
	<script></script>
	<link rel="EditURI" type="application/rsd+xml" title="RSD"
		href="https://demo.kamleshyadav.com/themeforest/videospire/videospire-rtl/xmlrpc.php?rsd">
	<link rel="stylesheet" href="{{asset('assets/css/rtl.css')}}" media="screen">
	<meta name="generator" content="WordPress 6.8.3">
	<meta name="generator" content="WooCommerce 9.9.3">
	{{-- <link rel="canonical" href="https://demo.kamleshyadav.com/themeforest/videospire/videospire-rtl/"> --}}
	{{-- <link rel="shortlink" href="https://demo.kamleshyadav.com/themeforest/videospire/videospire-rtl/"> --}}
	<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
		href="https://demo.kamleshyadav.com/themeforest/videospire/videospire-rtl/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fdemo.kamleshyadav.com%2Fthemeforest%2Fvideospire%2Fvideospire-rtl%2F">
	...
	<meta name="generator" content="Cryptoyaar">
	<style type="text/css" data-type="vc_shortcodes-custom-css">
		.vc_custom_1663832536943 {
	...
	<style>
		...
		@media (max-width: 768px) {
			...
			/* Header overall height kam karne ke liye */
				.ms-header-wrapper {
					padding: 8px 0 !important;
				}

				/* Right side items align & height control */
				.ms-header-right {
					min-height: auto !important;
					align-items: center;
				}

				/* Menu items spacing kam */
				.ms-header-menu ul.menu > li > a {
				...
				/* Logo height control */
				.ms-header-logo img {
					max-height: 45px;   /* pehle 60–70px hota hai */
				}

				/* Profile dropdown spacing kam */
				.ms-header-profile {
					padding: 0 10px !important;
				}

				/* Download button height kam */
...
<body
	class="ltr home wp-singular page-template-default page page-id-1143 wp-embed-responsive wp-theme-videospire theme-videospire woocommerce-no-js no-sidebar videospire-demo ms-videospire-blog videospire-dark wpb-js-composer js-comp-ver-7.5 vc_responsive">
				...
				<div class="col-lg-10 col-md-9 col-sm-12">
					<div class="ms-header-right">
							...
							<div class="profile-drodown">
								<div class="ms-profile-dropdown">
									...
									<div class="ms-profile-menus">
										<div class="menu-profile_menu-container">
											<ul id="videospire-menu-profile" class="menu-profile">
												<li id="menu-item-1461"
													class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1461">
													<a href=""
														title="Profile"
														class="menu-image-title-after menu-image-hovered"><span
															class="menu-image-hover-wrapper"><img width="14" height="13"
																src="{{asset('assets/img/profile12-1-1.svg')}}"
																class="menu-image menu-image-title-after" alt=""
																decoding="async"><img width="14" height="13"
																src="{{asset('assets/img/profile-2.svg')}}"
																class="hovered-image menu-image-title-after" alt=""
																style="margin-right: -24px;"
																decoding="async"></span><span
															class="menu-image-title nav_text">Profile</span></a></li>
												<li id="menu-item-1462"
													class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1462">
													<a href=""
														title="Language"
														class="menu-image-title-after menu-image-hovered"><span
															class="menu-image-hover-wrapper"><img width="15" height="14"
																src="{{asset('assets/img/laungage1323-1.svg')}}"
																class="menu-image menu-image-title-after" alt=""
																decoding="async"><img width="15" height="14"
																src="{{asset('assets/img/laungage-2.svg')}}"
																class="hovered-image menu-image-title-after" alt=""
																style="margin-right: -24px;"
																decoding="async"></span><span
															class="menu-image-title nav_text">Language</span></a></li>
												<li id="menu-item-1460"
													class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1460">
													<a href=""
														title="Buy Plan"
														class="menu-image-title-after menu-image-hovered"><span
															class="menu-image-hover-wrapper"><img width="14" height="14"
																src="{{asset('assets/img/plan-1-1-1.svg')}}"
																class="menu-image menu-image-title-after" alt=""
																decoding="async"><img width="14" height="14"
																src="{{asset('assets/img/plan-2.svg')}}"
																class="hovered-image menu-image-title-after" alt=""
																style="margin-right: -24px;"
																decoding="async"></span><span
															class="menu-image-title nav_text">Buy Plan</span></a></li>
											</ul>
										</div>
									</div>
									<ul>
										<li class="ms-profile-logout">
											...
											<img src="{{asset('assets/img/logout.svg')}}" alt="logout">
											<img src="{{asset('assets/img/logout-hover.svg')}}" alt="logout">
											<a href=""
												class="ms_btn">Logout</a>
										</li>
										<li class="ms-darkmode">
											<div class="toggle-box">
												<label>
													<input type="checkbox" id="checbox" checked="">
													<input type="hidden" data-color="color"
														name="videospire_template_url"
														value="">
						...
						<div class="ms-header-login-btn">
							<a href="javascript:;" class="ms-btn" data-bs-toggle="modal"
