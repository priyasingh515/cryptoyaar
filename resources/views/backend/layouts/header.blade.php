                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="{{route('admin.dashboard')}}" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{asset('assets/admin/images/logo2.png')}}" alt="logo-sm-light" height="30">
                                </span>
                                <span class="logo-lg">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{asset('assets/admin/images/users/user.png')}}"
                                    alt="Header Avatar">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            @if(auth('admin')->user()->hasPermission('create-member') ||auth('admin')->user()->hasPermission('view-member'))
                                ...
                                <li class="{{ $memberActive ? 'mm-active' : '' }}">
                                    <a href="javascript:void(0);" class="has-arrow waves-effect {{ $memberActive ? 'mm-active' : '' }}">
                            ...
                            @if(auth('admin')->user()->hasPermission('create-category') ||auth('admin')->user()->hasPermission('view-category'))
                                ...
                                <li class="{{ $categoryActive ? 'mm-active' : '' }}">
                                    <a href="javascript:void(0);" class="has-arrow waves-effect {{ $categoryActive ? 'mm-active' : '' }}">
                                        <i class="bx bx-user"></i>
                                        <span>Category</span>
                                    </a>
                            ...
                            @if(auth('admin')->user()->hasPermission('create-permission') ||auth('admin')->user()->hasPermission('view-permission'))
                                <li class="{{ $PermissionActive ? 'mm-active' : '' }}">
                                    <a href="javascript:void(0);" class="has-arrow waves-effect {{ $PermissionActive ? 'mm-active' : '' }}">
